...
export default function OurWork({ projects }: { projects: Project[] }) {
    ...
    return (
        <section>
            <HeaderBlack />
            <div className="w-screen md:max-h-[calc(100vh-32px)] min-h-[calc(100vh-32px)] bg-[var(--color-baby-powder)] flex items-center px-4 lg:px-8 xl:px-16">
                        ...
                        <div className="flex flex-col justify-between md:col-span-3 lg:col-span-3">
                            <AnimatePresence mode="wait">
                                ...
                                >
                                    ...
                                    >
                                        <h1 className="font-semibold text-base pt-4 md:pt-0 uppercase">
                                            {projects[view].name}
                                        </h1>
